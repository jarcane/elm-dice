...
var _jarcane$elm_dice$Main$rollDice = F2(
	function (num, sides) {
		var _p0 = {
			ctor: '_Tuple2',
			_0: _elm_lang$core$String$toInt(num),
...
var _jarcane$elm_dice$Main$model = A5(
	...
	_elm_lang$core$Maybe$Nothing);
var _jarcane$elm_dice$Main$init = {ctor: '_Tuple2', _0: _jarcane$elm_dice$Main$model, _1: _elm_lang$core$Platform_Cmd$none};
var _jarcane$elm_dice$Main$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _jarcane$elm_dice$Main$numberField = F5(
	function (model, idNum, msg, lbl, val) {
		return A5(
			...
			model.mdl,
			{
				...
				_1: {
					ctor: '::',
					_0: _debois$elm_mdl$Material_Textfield$label(lbl),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Textfield$value(val),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _jarcane$elm_dice$Main$NewResult = function (a) {
...
var _jarcane$elm_dice$Main$NewSides = function (a) {
	return {ctor: 'NewSides', _0: a};
};
var _jarcane$elm_dice$Main$NewNum = function (a) {
	return {ctor: 'NewNum', _0: a};
};
var _jarcane$elm_dice$Main$viewBody = function (model) {
			...
			},
			{
				header: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Die Roller'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
				...
				main: {
					ctor: '::',
					_0: _jarcane$elm_dice$Main$viewBody(model),
					_1: {ctor: '[]'}
				}
			}));
};
var _jarcane$elm_dice$Main$main = _elm_lang$html$Html$program(
	{init: _jarcane$elm_dice$Main$init, view: _jarcane$elm_dice$Main$view, update: _jarcane$elm_dice$Main$update, subscriptions: _jarcane$elm_dice$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _jarcane$elm_dice$Main$main !== 'undefined') {
    _jarcane$elm_dice$Main$main(Elm['Main'], 'Main', undefined);
}
